...
LandDemand$`Harvested area` <- LandDemand$`Harvested area` * 1000   #convert from ?? to ??  #saloni
LandDemand$Production <- LandDemand$`Harvested area` * LandDemand$`Crop yield` #calculate production in ?? units #saloni
